        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // İşbirlikçi olmak isteyenler için başvuru isteği oluştur
                    if (Input.ApplyAsCompany)
                    {
                        if (!await _roleManager.RoleExistsAsync("Company"))
                            await _roleManager.CreateAsync(new IdentityRole("Company"));

                        // Başvuru tablosuna kayıt (modeli birazdan açıklıyorum)
                        _context.CompanyRequests.Add(new CompanyRequest
                        {
                            UserId = user.Id,
                            Email = user.Email,
